...
window.addEventListener('DOMContentLoaded', function () {
    ...
    document.getElementById("p1health").value = localStorage.getItem("p1");
    document.getElementById("enemyhealth").value = localStorage.getItem("enemy");
...
function updatestats() {
    ...
    localStorage.setItem("p1", p1health);
    localStorage.setItem("enemy", enemyhealth);
}